...
function displayError(message){
	//TODO. if mesasage blank then we should hide it, depends on the css
...
function displayMovie( data, container, hearted ){
	...
	for (var prop in data) {
        ...
        //skip if a type we've dealth with
	...
	if ( hearted === true ) {
		...
		btn.addEventListener("click", function(e){ 
			...
			console.log("movie_id" + JSON.stringify(data));
...
function loadMovie( id, container, hearted ){
	...
	console.log("loading movie: " + container.id);
